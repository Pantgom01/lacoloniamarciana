    ...
    const teams = ["Astrofísicos","Astrobiólogos","Geólogos Planetarios","Ingenieros de Comunicaciones", "Sanitarios", "Programadores", "Técnicos Robóticos", "Biotecnólogos",   "Ingenieros de Navegación", "Analistas de Datos", "Especialistas en IA", "Exploradores de Superficie", "Soporte Vital"];
